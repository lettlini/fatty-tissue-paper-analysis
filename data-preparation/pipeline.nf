...
workflow data_preparation {
    ...
    confluency_filter(prepare_dataset_from_raw.out.results, publish_dir)
    nuclei_segmentation(confluency_filter.out.results, params.min_nucleus_area_mumsq, publish_dir)
